...
Player::Player(QGraphicsView *theWindow) {
    ...
    //Make wing turrets
    WingTurretL = new Turret<Missle>(this, Player::pixelWidth/4, Player::pixelHeight/2, 30000);
    WingTurretR = new Turret<Missle>(this, 3*Player::pixelWidth/4, Player::pixelHeight/2, 30000);
}
